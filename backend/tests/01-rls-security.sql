...
--   5. The two-seat cap rejects a third member even via the service role.
--   6. Private check-ins/reflections are invisible to co-caregivers.
--
...
-- Family 1: full (owner + partner), with events, check-ins, tokens, audit.
...
-- ===========================================================================
-- Block G — redemption + seat cap (service-role emulation of redeem-invite)
-- ===========================================================================
select throws_ok(
  $$ insert into family_members (family_id, user_id, role)
     values ('10000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000003', 'partner') $$,
  'P0001',
  'Family is full (MVP cap is 2 caregivers)',
  'G1: two-seat cap rejects a third member even via the service role'
);
select lives_ok(
