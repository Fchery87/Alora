...
| Hosted pgTAP     | 52/52 verified by the user through migration `20260814000400` | The six `20260815...` migrations expand the suite to 74 assertions and still need `supabase db push` plus a fresh run.                                                                          |
...
| ------------------------------- | ----------------------- | --------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------- |
| Release contract and migrations | Code complete           | Canonical additive migration history, no direct membership-management path, and updated runner.                                         | Apply the six new migrations to the linked project.                                     |
