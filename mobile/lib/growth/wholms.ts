// WHO Child Growth Standards (2006) — LMS parameters, ages 0–24 months.
// ---------------------------------------------------------------------------
// GENERATED FILE — do not edit by hand. Regenerate from the CDC data files:
//   https://ftp.cdc.gov/pub/Health_Statistics/NCHS/growthcharts/who-data-files.htm
//   (WHO-Boys|Girls-{Weight,Length,Head-Circumference}-for-age-Percentiles.csv)
// Rows are indexed by month 0..24 (CDC half-month convention: row m covers
// ages m..m+1). L = Box-Cox power, M = median, S = generalized CV.
// Retrieved 2026-08. Percentile math lives in ./percentile.ts.

export type GrowthMeasure = "weight" | "length" | "head";
export type BabySex = "boy" | "girl";

/** [L, M, S] indexed by month (0–24). */
export const WHO_LMS: Record<GrowthMeasure, Record<BabySex, [number, number, number][]>> = {
  weight: {
    boy: [
